...
$("document").ready(function() {
  ...
  $("#logo_2").css("float", "left");
  $("#logo_2").css("margin-right", "10px");
  $(".p__two").css("color", "purple");
  $(".p__two").css("margin-top", "10px");

  // How to pass in multiple arguments
  $(".p__two").css({"background" : "url('repeatBkgrnd.png') repeat-y"});

  // Target elements by tag
  $("a").css("color", "red");

  // Target tags only in other tags, classes, or ids
  $("#table_Data a").css("color", "green");
  ...
  $("#o_ListIndent li:nth-child(3)").css("color", "red");
  ...
  $("a[href*='google']").css("font-size", "25px");
  ...
  $("#table_Data tr:even").css("background-color", "rgb(206, 198, 32)");
  $("#table_Data tr:odd").css("background-color", "#F0F8FF");

  // Select the first matching element
  $("#table_Data tr:first").css({"background-color" : "#001A57", "color" : "white"});

  // Select the last matching element
  $("#table_Data tr:last").css("background-color", "#FFC0DB");

  // Select the elements that don't contain 'and' in them
  $("#o_ListTypes li:not(:contains(and))").css("color", "red");
  ...
  $("#o_ListIndent li").each(function(index) {
