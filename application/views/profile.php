...
<body>
	<div align="center">
        <h2>Google authentication library for Codeigniter <?php echo $message_display; ?></h2>
    </div>
    <div class="container">
        <div class="row">
        ...
        <div class="col s12 m6 l4 offset-l3 " >
        	<div class="card ">
        		...
        		<div class="card-content">
        			<span class="card-title activator grey-text text-darken-4"> <i class="material-icons"><?php= $_SESSION['name'] ?></i></span>
        		</div>
